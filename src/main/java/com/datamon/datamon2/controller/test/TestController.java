...
import com.datamon.datamon2.servcie.logic.test.TestService;
...
public class TestController {
    ...
    public ResponseEntity<?> uuidTest(HttpServletRequest request, HttpServletResponse response, @RequestParam String dbCode){
        return new ResponseEntity<>(testService.uuidTest(dbCode), HttpStatus.OK);
    }
}